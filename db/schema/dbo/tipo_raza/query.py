...
from db.schema.dbo.tipo_raza.mapper import TipoRazaDataClass
from db.schema.dbo.tipo_raza.table import TipoRazaTable


class TipoRazaQueryBuilder(QueryBuilder):

    def __init__(self):
        self._table = TipoRazaTable()
        self._q: Union[MSSQLQuery, MSSQLQueryBuilder] = MSSQLQueryBuilder()

    def insert(self, o: TipoRazaDataClass):
