...
from db.schema.dbo.tipo_sexo.mapper import TipoSexoDataClass
from db.schema.dbo.tipo_sexo.table import TipoSexoTable


class TipoSexoQueryBuilder(QueryBuilder):

    def __init__(self):
        self._table = TipoSexoTable()
        self._q: Union[MSSQLQuery, MSSQLQueryBuilder] = MSSQLQueryBuilder()

    def insert(self, o: TipoSexoDataClass):
