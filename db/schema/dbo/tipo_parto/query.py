...
from db.schema.dbo.tipo_parto.mapper import TipoPartoDataClass
from db.schema.dbo.tipo_parto.table import TipoPartoTable


class TipoPartoQueryBuilder(QueryBuilder):

    def __init__(self):
        self._table = TipoPartoTable()
        self._q: Union[MSSQLQuery, MSSQLQueryBuilder] = MSSQLQueryBuilder()

    def insert(self, o: TipoPartoDataClass):
