...
from db.schema.dbo.tipo_denticion.mapper import TipoDenticionDataClass
from db.schema.dbo.tipo_denticion.table import TipoDenticionTable


class TipoDenticionQueryBuilder(QueryBuilder):

    def __init__(self):
        self._table = TipoDenticionTable()
        self._q: Union[MSSQLQuery, MSSQLQueryBuilder] = MSSQLQueryBuilder()

    def insert(self, o: TipoDenticionDataClass):
